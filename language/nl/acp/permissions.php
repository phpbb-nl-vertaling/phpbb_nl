...
$lang = array_merge($lang, array(
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Hier kan je globale permissies toewijzen aan groepen - gebruikerpermissies, globale moderatorpermissies en beheerderpermissies. Gebruikerpermissies bevatten ook mogelijkheden zoals het gebruik van avatars, het versturen van privéberichten, enzovoort; globale moderatorpermissies bevatten het goedkeuren van berichten, beheer van onderwerpen, beheer van verbanningen, enzovoort en als laatste beheerderpermissies bevatten het aanpassen van permissies, eigen BBCodes definiëren, beheer van forums, enzovoort. Individuele gebruikerpermissies zouden alleen veranderd moeten worden in uitzonderlijke gevallen, de voorkeursmethode is het plaatsen van gebruikers in groepen en dan het toewijzen van groepspermissies.',
	...
	'ACP_VIEW_USER_PERMISSIONS_EXPLAIN'			=> 'Hier kan je de effectieve gebruikerpermissis bekijken die toegewezen zijn aan de geselecteerde gebruikers/groepen.',
	...
	'AUTH_UPDATED'				=> 'Permissies zijn geüpdatet.',
	...
	'PERMISSION_APPLIED_TO_ALL'		=> 'Permissies en rol zullen ook toegepast worden aan alle geselecteerde objecten',
	...
	'TRACE_USER_KEPT'						=> 'De gebruikers permissie is <strong>NEE</strong> dus de oude totale waarde wordt behouden.',
	'TRACE_USER_KEPT_LOCAL'					=> 'De gebruikers permissie voor dit forum is <strong>NEE</strong> dus de oude totale waarde wordt behouden.',
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> 'De gebruikers permissie is ingesteld op <strong>NOOIT</strong> en de totale waarde is ingesteld op <strong>NOOIT</strong>, er veranderd dus niks.',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'De gebruikers permissie voor dit forum is ingesteld op <strong>NOOIT</strong> en de totale waarde is ingesteld op <strong>NOOIT</strong>, er veranderd dus niks.',
	'TRACE_USER_NEVER_TOTAL_NO'				=> 'De gebruikers permissie is ingesteld op <strong>NOOIT</strong> wat de totale waard wordt, omdat deze ingesteld was op NEE.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'De gebruikers permissie voor dit forum is ingesteld op <strong>NOOIT</strong> wat de totale waarde wordt, omdat deze ingesteld was op NEE.',
	'TRACE_USER_NEVER_TOTAL_YES'			=> 'De gebruikers permissie is ingesteld op <strong>NOOIT</strong> en overschrijft daarmee de vorige <strong>JA</strong>.',
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> 'De gebruikers permissie voor dit forum is ingesteld op <strong>NOOIT</strong> en overschrijft daarmee de vorige <strong>JA</strong>.',
	'TRACE_USER_NO_TOTAL_NO'				=> 'De gebruikers permissie is <strong>NEE</strong> en de totale waarde is ingesteld op NEE, dus wordt het standaard <strong>NOOIT</strong>.',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'De gebruikers permissie voor dit forum is <strong>NEE</strong> en de totale waarde is ingesteld op NEE, dus wordt het standaard <strong>NOOIT</strong>.',
	'TRACE_USER_YES_TOTAL_NEVER'			=> 'De gebruikers permissie is ingesteld op <strong>JA</strong> maar de totale <strong>NOOIT</strong> kan niet worden overschreven.',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'De gebruikers permissie voor dit forum is ingesteld op <strong>JA</strong> maar de totale <strong>NOOIT</strong> kan niet worden overschreven.',
	'TRACE_USER_YES_TOTAL_NO'				=> 'De gebruikers permissie is ingesteld op <strong>JA</strong> wat de totale waarde wordt, omdat het ingesteld was op <strong>NEE</strong>.',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> 'De gebruikers permissie voor dit forum is ingesteld op <strong>JA</strong> wat de totale waarde wordt, omdat het ingesteld was op <strong>NEE</strong>.',
	'TRACE_USER_YES_TOTAL_YES'				=> 'De gebruikers permissie is ingesteld op <strong>JA</strong> en de totale waarde is ingesteld op <strong>JA</strong>, er veranderd dus niks.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'De gebruikers permissie voor dit forum is ingesteld op <strong>JA</strong> en de totale waarde is ingesteld op <strong>JA</strong>, er veranderd dus niks.',
	'TRACE_WHO'								=> 'Wie',
	'TRACE_TOTAL'							=> 'Totaal',
	...
	'WRONG_PERMISSION_SETTING_FORMAT'	=> 'De permissie-instellingen zijn in een verkeerde formaat, phpBB kan ze niet correct verwerken.',
));
