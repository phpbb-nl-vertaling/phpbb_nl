...
$lang = array_merge($lang, array(
	...
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> 'Door het kiezen van deze rol veranderd er niks aan de permissies rechts. Als je alle permissies wilt verwijderen moet je gebruik maken van de “Alles <samp>NEE</samp>” link.',
	...
	'ROLE_DESCRIPTION_FORUM_NEW_MEMBER'		=> 'Een rol voor leden van de speciale “Pas Geregistreerde Gebruikers”-groep; bevat <samp>NOOIT</samp> permissies om functies uit te sluiten voor nieuwe gebruikers.',
	...
	'ROLE_DESCRIPTION_USER_NEW_MEMBER'		=> 'Een rol voor leden van de speciale “Pas Geregistreerde Gebruikers”-groep; bevat <samp>NOOIT</samp> permissies om functies uit te sluiten voor nieuwe gebruikers.',
	...
	'TRACE_DEFAULT'					=> 'Standaard staat iedere permissie op <samp>NEE</samp> (niet ingesteld). De permissie kan dus overschreven worden door andere instellingen.',
	'TRACE_FOR'						=> 'Tracering voor',
	'TRACE_GLOBAL_SETTING'			=> '%s (globaal)',
	'TRACE_GROUP_NEVER_TOTAL_NEVER'	=> 'Deze groepspermissie is ingesteld op <samp>NOOIT</samp> net zoals het totale resultaat, zodat het oude resultaat wordt behouden.',
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'Deze groepspermissie voor dit forum is ingesteld op <samp>NOOIT</samp> net zoals het totale resultaat, zodat het oude resultaat behouden blijft.',
	'TRACE_GROUP_NEVER_TOTAL_NO'	=> 'Deze groepspermissie is ingesteld op <samp>NOOIT</samp>, wat de nieuwe totale waarde wordt, omdat het nog niet ingesteld was (ingesteld op <samp>NEE</samp>).',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Deze groepspermissie voor dit forum is ingesteld op <samp>NOOIT</samp>, wat de nieuwe totale waarde wordt, omdat het nog niet ingesteld was (ingesteld op <samp>NEE</samp>).',
	...
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'Deze groepspermissie voor dit forum is ingesteld op <samp>NOOIT</samp> wat de totale <samp>JA</samp> zal overschrijven naar een <samp>NOOIT</samp> voor deze gebruiker.',
	'TRACE_GROUP_NO'				=> 'De permissie is <samp>NEE</samp> voor deze groep, zodat de oude totale waarde behouden blijft.',
	'TRACE_GROUP_NO_LOCAL'			=> 'De permissie is <samp>NEE</samp> voor deze groep in dit forum, zodat de oude totale waarde behouden blijft.',
	'TRACE_GROUP_YES_TOTAL_NEVER'	=> 'Deze groepspermissie is ingesteld op <samp>JA</samp>, maar de totale <samp>NOOIT</samp> kan niet overschreven worden.',
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'	=> 'Deze groepspermissie voor dit forum is ingesteld op <samp>JA</samp>, maar de totale <samp>NOOIT</samp> kan niet overschreven worden.',
	'TRACE_GROUP_YES_TOTAL_NO'		=> 'Deze groepspermissie is ingesteld op <samp>JA</samp> wat de nieuwe totale waarde wordt, omdat het nog niet ingesteld was (ingesteld op <samp>NEE</samp>).',
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Deze groepspermissie voor dit forum is ingesteld op <samp>JA</samp> wat de totale nieuwe waarde wordt, omdat het nog niet ingesteld was (ingsteld op <samp>NEE</samp>).',
	...
	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'	=> 'Deze groepspermissie voor dit forum is ingesteld op <samp>JA</samp> en de totale permissie is al ingesteld op <samp>JA</samp>, dus het totale resultaat blijft behouden.',
