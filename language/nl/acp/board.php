...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Dit zal het forum niet beschikbaar maken voor gebruikers die geen beheerders of moderators zijn. Je kan ook een kort (255 karakters) bericht invoeren dat wordt weergegeven indien gewenst.',
...
$lang = array_merge($lang, array(
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'Minimum aantal karakters dat een gebruiker in een bericht/privébericht moet invoeren. Het minimum voor deze instelling is 1.',
	'POSTING'						=> 'Berichten',
	'POSTS_PER_PAGE'				=> 'Berichten per pagina',
	'QUOTE_DEPTH_LIMIT'				=> 'Maximum nestelingsdiepte voor citaten',
	'QUOTE_DEPTH_LIMIT_EXPLAIN'		=> 'Maximum aantal citaat nestelingsdiepte in een bericht. Stel in op 0 voor ongelimiteerde diepte.',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'We kunnen niet vaststellen of deze server URL herschrijving ondersteunt. Deze instelling kan ingeschakeld zijn, maar als URL herschrijven niet beschikbaar is, kunnen paden aangemaakt door dit forum (zoals voor gebruik in koppelingen) gebroken zijn. Neem contact op met je web hosting provider als je niet zeker bent of je veilig deze functie kan inschakelen.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Bepaalt of gebruikers gebruik kunnen maken van de "Ik ben mijn wachtwoord vergeten" koppeling op de aanmeldpagina om hun account terug te krijgen. Als je gebruik maakt van een externe authenticatie mechanisme, kan je ervoor kiezen deze functie uit te schakelen.',
