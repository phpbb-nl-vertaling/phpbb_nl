...
$lang = array_merge($lang, array(
	...
	'OVERRIDE_STYLE_EXPLAIN'		=> 'Vervangt de gebruikersstijl (en stijl voor gasten) met de stijl die gedefinieerd is onder “Standaardstijl”.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> 'Dit bepaalt of gebruikers meteen toegang hebben tot het forum of dat er bevestiging vereist is. Je kan ook nieuwe registraties compleet uitschakelen. “Forum-wijde e-mails” moet ingeschakeld zijn om gebruiker- of beheerdersactivatie te gebruiken.',
...
$lang = array_merge($lang, array(
	...
	'FORCE_SERVER_VARS_EXPLAIN'	=> 'Indien ingesteld op ja, dan zullen de server instellingen die hier gedefinieerd zijn gebruikt worden in plaats van de geautomatiseerde vastgestelde waardes.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Als dit is uitgeschakeld, zullen geen e-mails door het forum verstuurd worden. <em>Let op dat de gebruikerss- en beheerdersaccount-activatie instellingen vereisen dat deze instelling is ingeschakeld. Als momenteel gebruik wordt gemaakt van “gebruiker”- of “beheerder” activatie in de activatieinstellingen, zal het uitschakelen van deze instelling geen activatie vereisen van nieuwe accounts.</em>',
