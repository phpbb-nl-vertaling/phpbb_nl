...
$lang = array_merge($lang, array(
	...
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Het onderwerp van het laatst toegevoegde bericht zal weergegeven worden op de forumlijst met een link naar het bericht. Onderwerpen van forums die met een wachtwoord zijn beveiligd en forums waarvan de gebruiker geen leesrechten heeft, zullen niet weergegeven worden.',
	...
	'SITE_HOME_URL_EXPLAIN'			=> 'Indien opgegeven, een link naar deze URL zal voor je broodkruimels komen en het logo zal naar deze URL linken in plaats van het forum. Een absolute URL is vereist, bijv. <samp>http://www.phpbbservice.nl</samp>.',
	'SITE_NAME'						=> 'Sitenaam',
...
$lang = array_merge($lang, array(
	...
	'PM_MAX_RECIPIENTS_EXPLAIN'	=> 'Het maximum aantal toegestane ontvangers in een privébericht. Indien 0 is ingevoerd, een ongelimiteerd aantal is toegestaan. Deze instelling kan voor iedere groep apart aangepast worden in de groepsinstellingen pagina.',
));
...
$lang = array_merge($lang, array(
	...
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> 'Maximum breedte van een afbeelding/flash-bestand in berichten. Stel in op 0 voor ongelimiteerde grootte.',
...
$lang = array_merge($lang, array(
	...
	'LIMIT_SESSIONS_EXPLAIN'		=> 'Als het aantal sessies deze waarde overschrijft binnen een minuut, dan zal het forum offline gaan. Stel in op 0 voor onbeperkt aantal sessies.',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'Zowel de sleutel als het geheim van ieder ingeschakelde OAuth service provider moet worden opgegeven. Er is alleen één opgegeven voor een OAuth service provider.',
        'AUTH_PROVIDER_OAUTH_EXPLAIN' => 'Ieder OAuth provider vereist een uniek geheim en sleutel om te kunnen authenticeren met de externe server. Deze worden geleverd bij de OAuth service wanneer je je website registreert bij hun en moet precies zoals geleverd ingevoerd worden.<br />Elke service dat niet een sleutel en geheim heeft ingevoerd, zal niet beschikbaar zijn voor gebruik door forumgebruikers. Let op: de gebruiker kan zich nog steeds registeren en inloggen via de DB authenticatie plug-in',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_ENABLE_EXPLAIN' => 'Wanneer ingeschakeld, URLs die ’app.php’ bevatten zullen herschreven worden om de bestandsnaam te verwijderen (bijv. app.php/foo zal /foo worden). <strong>Apache server’s mod_rewrite module is vereist om deze functie te kunnen werken; als deze optie is ingeschakeld zonder mod_rewrite ondersteuning, URLs op je forum kunnen gebroken zijn.</strong>',
	'MOD_REWRITE_DISABLED'		=> 'De <strong>mod_rewrite</strong> module op je Apache web server is uitgeschakeld. Schakel de module in of neem contact op met je web hosting provider als je deze functie wilt inschakelen.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'We kunnen niet vaststellen of deze server URL herschrijving ondersteunt. Deze instelling kan ingeschakeld zijn, maar als URL herschrijven niet beschikbaar is, kunnen paden aangemaakt door dit forum (zoals voor gebruik in links) gebroken zijn. Neem contact op met je web hosting provider als je niet zeker bent of je veilig deze functie kan inschakelen.',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_CHECK_MX_EXPLAIN'		=> 'Indien ingeschakeld, wordt het e-maildomein gegeven bij registraties en bij profielwijzigingen gecontroleerd voor een geldig MX-record.',
	...
	'FORWARDED_FOR_VALID_EXPLAIN'	=> 'Sessies zullen alleen doorgaan als de verzonden <var>X_FORWARDED_FOR</var> kop gelijk is aan de één verstuurd met het vorige verzoek. Verbanningen zullen ook gecontroleerd worden op IPs in <var>X_FORWARDED_FOR</var>.',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_PACKAGE_SIZE_EXPLAIN'	=> 'Dit is het maximale aantal e-mails verstuurdt in één pakket. Deze instelling wordt toegepast op de interne berichtenwachtrij; stel deze waarde in op 0 als je problemen hebt met niet afgeleverde notificatie e-mails.',
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Als dit is uitgeschakeld, zullen geen e-mails door het forum verstuurd worden. <em>Let op dat de gebruiker en beheerder accountactivatie instellingen vereisen dat deze instelling is ingeschakeld. Als momenteel gebruik wordt gemaakt van “gebruiker” of “beheerder” activatie in de activatieinstellingen, zal het uitschakelen van deze instelling geen activatie vereisen van nieuwe accounts.</em>',
