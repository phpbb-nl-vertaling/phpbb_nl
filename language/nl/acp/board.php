...
$lang = array_merge($lang, array(
	...
	'ALLOW_FLASH_PM_EXPLAIN'	=> 'Let op dat het gebruik van flash in privéberichten, indien hier toegestaan, ook afhankelijk is van de rechten.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_POST_FLASH_EXPLAIN'			=> 'Indien niet toegestaan is de <code>[FLASH]</code> BBCode-tag uitgeschakeld in berichten. Anders controleert het rechtensysteem welke gebruikers gebruik kunnen maken van de <code>[FLASH]</code> BBCode-tag.',
	...
	'FLOOD_INTERVAL_EXPLAIN'		=> 'Aantal seconden dat een gebruiker moet wachten tussen het plaatsen van nieuwe berichten. Om gebruikers toe te staan dit te negeren moet je hun eigen rechten aanpassen.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Nieuwe gebruikers blijven in de <em>Nieuw geregistreerde gebruikers</em>-groep totdat ze dit aantal berichten hebben bereikt. Je kunt deze groep gebruiken om te voorkomen dat ze het PB-systeem meteen kunnen gebruiken of om hun berichten na te kijken. <strong>Een waarde van 0 zal deze functie uitschakelen.</strong>',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_EMAIL_EXPLAIN'			=> 'Dit zal gebruikt worden als het antwoordadres voor alle e-mails, het technische contact-e-mailadres. Het zal altijd gebruikt worden als <samp>Antwoordpad</samp> en <samp>Afzender</samp>-adres in e-mails.',
