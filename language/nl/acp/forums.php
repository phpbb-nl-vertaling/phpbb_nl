...
$lang = array_merge($lang, array(
	...
	'CONTINUE'						=> 'Doorgaan',
	'COPY_PERMISSIONS'				=> 'Kopiëer rechten van',
	'COPY_PERMISSIONS_EXPLAIN'		=> 'Om de rechten-instellingen voor je nieuwe forum te vergemakkelijken, kun je de rechten van een bestaand forum kopiëren.',
	'COPY_PERMISSIONS_ADD_EXPLAIN'	=> 'Eenmaal aangemaakt zal het forum dezelfde rechten hebben als degene die je hier selecteert. Als er geen forum wordt geselecteerd zal het nieuw aangemaakte forum niet zichtbaar zijn totdat de rechten ingesteld zijn.',
	'COPY_PERMISSIONS_EDIT_EXPLAIN'	=> 'Als je ervoor kiest om rechten te kopiëren zal dit forum dezelfde rechten krijgen als degene die je hier selecteert. Dit zal de bestaande rechten die je de vorige keer hebt ingesteld voor dit forum, overschrijven met de rechten van het forum dat je hier selecteert. Als er geen forum is geselecteerd zullen de bestaande rechten intact blijven.',
	'COPY_TO_ACL'					=> 'Je kunt ook %snieuwe rechten instellen%s voor dit forum.',
	...
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> 'Schakelt de snelle reacties in voor dit forum. Deze instelling wordt gebruikt als snelle reacties uitgeschakeld is op het gehele forum. De snelle reacties zal alleen weergegeven worden aan gebruikers die de rechten hebben om in dit forum berichten te plaatsen.',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'In phpBB3 is alles forum-gebaseerd. Een categorie is gewoon een speciaal type forum. Elk forum kan een onbeperkt aantal subforums hebben en je kunt beslissen of er berichten in geplaatst mogen worden of niet (bijvoorbeeld wanneer het zich voor doet als een oude categorie). Hier kun je individuele forums toevoegen, wijzigen, verwijderen, sluiten, openen en ook nog bepaalde extra instellingen instellen. Als je berichten en onderwerpen niet meer kloppen qua aantallen kun je ook nog een forum synchroniseren. <strong>Je moet rechten kopiëren of instellen voor nieuw aangemaakte forums zodat ze zichtbaar zijn.</strong>',
	...
	'FORUM_DESC_EXPLAIN'				=> 'Alle HTML-opmaak die hier wordt ingevuld zal worden weergegeven zoals het ingevoerd is.',
	'FORUM_EDIT_EXPLAIN'				=> 'Het formulier hieronder staat je toe om dit forum aan te passen. Let op dat moderatie en berichtenteller-controles ingesteld worden via forumrechten voor iedere gebruiker of gebruikersgroep.',
	...
	'FORUM_PASSWORD_EXPLAIN'			=> 'Definieert een wachtwoord voor dit forum, gebruik bij voorkeur het rechtensysteem.',
	...
	'NO_PERMISSIONS'				=> 'Rechten niet kopiëren',
	'NO_PERMISSION_FORUM_ADD'		=> 'Je hebt niet de benodigde rechten om forums toe te voegen.',
	'NO_PERMISSION_FORUM_DELETE'	=> 'Je hebt niet de benodigde rechten om forum te verwijderen.',
	...
	'REDIRECT_ACL'	=> 'Nu kun je de %srechten instellen%s voor dit forum.',
