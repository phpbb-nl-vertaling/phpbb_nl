...
$lang = array_merge($lang, array(
	...
	'CANNOT_BAN_ANONYMOUS'			=> 'Je hebt niet de toestemming om de gastaccount te verbannen. Permissies voor anonieme gebruikers kunnen ingesteld worden onder de Permissies tab.',
	'CANNOT_BAN_FOUNDER'			=> 'Je hebt niet de toestemming om oprichteraccounts te verbannen.',
	'CANNOT_BAN_YOURSELF'			=> 'Je bent niet toegestaan om jezelf te verbannen.',
	'CANNOT_DEACTIVATE_BOT'			=> 'Je hebt niet de toestemming om botaccounts te deactiveren. Deactiveer de bot in plaats hiervan op de botpagina.',
	'CANNOT_DEACTIVATE_FOUNDER'		=> 'Je hebt niet de toestemming om oprichteraccounts te deactiveren.',
	'CANNOT_DEACTIVATE_YOURSELF'	=> 'Je bent niet toegestaan om je eigen account te deactiveren.',
	'CANNOT_FORCE_REACT_BOT'		=> 'Je hebt niet de toestemming om heractivatie van botaccounts te forceren. Heractiveer de bot in plaats hiervan op de botpagina.',
	'CANNOT_FORCE_REACT_FOUNDER'	=> 'Je hebt niet de toestemming om heractivatie van oprichteraccounts te forceren.',
	'CANNOT_FORCE_REACT_YOURSELF'	=> 'Je bent niet toegestaan om heractivatie van je eigen account te forceren.',
	'CANNOT_REMOVE_ANONYMOUS'		=> 'Je kan niet het gastaccount verwijderen.',
	'CANNOT_REMOVE_YOURSELF'		=> 'Je bent niet toegestaan om je eigen account te verwijderen.',
	'CANNOT_REMOVE_FOUNDER'			=> 'Je hebt niet de toestemming om oprichteraccounts te verwijderen.',
	...
	'CONFIRM_EMAIL_EXPLAIN'			=> 'Je hoeft dit alleen te specificeren als je de gebruikers e-mailadres aan het veranderen bent.',
