...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_BLOCK_GROUPS'	=> 'Type gebruikers en gebruikersgroepen',
	'HELP_FAQ_BLOCK_ISSUES'	=> 'phpBB 3 vragen',
	...
	'HELP_FAQ_BOOKMARKS_DIFFERENCE_ANSWER'	=> 'Bladwijzers in phpBB 3.0 zijn zoals bladwijzers (of favorieten) in je browser. Je wordt niet op de hoogte gebracht van updates, maar je kan altijd snel terugkeren. Het verschil met abonnementen ligt hem in het feit dat je hierbij automatisch op de hoogte gebracht word van updates, dit gebeurd via de door jou gekozen wijze.',
	...
	'HELP_FAQ_FORMATTING_STICKIES_ANSWER'	=> 'Sticky onderwerpen staan onder de mededelingen in het forum en alleen op de eerste pagina. Meestal zijn deze berichten vrij belangrijk, dus het lezen ervan is aangeraden. Net zoals bij mededelingen bepaalt de beheerder welke permissies je moet hebben om een sticky onderwerp te plaatsen.',
	'HELP_FAQ_FORMATTING_STICKIES_QUESTION'	=> 'Wat zijn sticky onderwerpen?',

	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> 'Hiermee kan je andere gebruikers op het forum sorteren. Gebruikers die in je vriendenlijst staan, worden in het gebruikerspaneel weergegeven zodat je snel kan controleren of ze online zijn, of een privébericht kan sturen. Tevens is het mogelijk dat hun berichten, in je huidige stijl, gemarkeerd worden. Als je een gebruiker aan je vijandenlijst toevoegt, worden zijn of haar berichten standaard verborgen.',
	...
	'HELP_FAQ_GROUPS_USERGROUPS_LEAD_ANSWER'	=> 'Gebruikersgroepen worden door de beheerder gemaakt, deze beslist dus ook wie de groepsleider is. Als je een gebruikersgroep wilt starten, moet je contact opnemen met de beheerder, dit kan door hem/haar een privébericht te sturen.',
	...
	'HELP_FAQ_ISSUES_ADMIN_ANSWER'	=> 'Alle gebruikers van het forum kunnen gebruik maken van het “Contact”-formulier, als de optie is ingeschakeld door de beheerders.<br />Leden van het forum kunnen ook gebruik maken van de “Het Team”-link.',
	...
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_ANSWER'	=> 'Er zijn verschillende redenen mogelijk waarom je dit probleem hebt. Controleer eerst of je gebruikersnaam en wachtwoord kloppen. Indien ze correct zijn, kan je contact opnemen met de beheerder om er zeker van te zijn dat je niet verbannen bent. Het is ook mogelijk dat de forumconfiguratie fout is, dan moet dit door de beheerder opgelost worden.',
	...
	'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'	=> 'Verwijder alle forumcookies zorgt dat alle cookies die door phpBB3 aangemaakt werden, verwijdert worden. Deze cookies zorgen ervoor dat je aangemeld bent en geven ook de mogelijkheid, indien de beheerder dit inschakelde, om te zien welke onderwerpen je al gelezen hebt.',
	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> 'Wat doet "verwijder alle forumcookies"?',
	...
	'HELP_FAQ_PMS_UNWANTED_ANSWER'	=> 'Je kan gebruikers blokkeren zodat ze je geen privéberichten meer kunnen sturen, dit gebeurt via het gebruikerspaneel. Als je ongepaste privéberichten ontvangt van een bepaalde gebruiker, neem dan contact op met de beheerder, deze kan ervoor zorgen dat hij of zij niet langer privéberichten kan sturen of gebruik de meldknop in het privébericht.',
	...
	'HELP_FAQ_POSTING_DRAFT_ANSWER'	=> 'Hiermee kan je berichten opslaan om ze dan later af te werken en te plaatsen. Een opgeslagen bericht kan je, via de bijhorende optie, in het gebruikerspaneel weer laden.',
	'HELP_FAQ_POSTING_DRAFT_QUESTION'	=> 'Waarvoor dient de "Opslaan"-knop bij het plaatsen van een bericht?',
	'HELP_FAQ_POSTING_EDIT_DELETE_ANSWER'	=> 'Tenzij je de beheerder of een moderator bent, kan je alleen je eigen berichten wijzigen en verwijderen. Je kan een bericht wijzigen (soms maar voor een beperkte tijd nadat het geplaatst is) door te klikken op de <em>wijzig</em> knop van het desbetreffende bericht. Als er al iemand op je bericht gereageerd heeft, komt er onderaan je bericht een klein tekstje dat zegt hoeveel keer en wanneer je het bericht voor het laatst je gewijzigd hebt. Dit zal niet verschijnen als nog niemand gereageerd heeft, evenmin als een beheerder of moderator je bericht gewijzigd heeft. Zij kunnen wel een mededeling toevoegen, waarom ze je bericht gewijzigd hebben. Het verwijderen van een bericht is niet meer mogelijk van zodra er iemand op gereageerd heeft.',
	...
	'HELP_FAQ_POSTING_REPORT_ANSWER'	=> 'Als de beheerder het toelaat, kan je op de hiervoor dienende knop klikken bij het bericht. Als je hierop geklikt hebt, moet je een paar verplichte stappen volgen om de melding te versturen.',
	...
	'HELP_FAQ_POSTING_WARNING_ANSWER'	=> 'Op ieder forum gelden specifieke regels, als je één van deze regels (volgens de beheerder) overtreedt, kan je een waarschuwing ontvangen. Het sturen van een waarschuwing naar je is een beslissing van de beheerder, phpBB Limited heeft hier dus in geen geval iets mee te maken.',
	...
	'HELP_FAQ_SEARCH_OWN_ANSWER'	=> 'Je kan je eigen berichten vinden door ofwel op de "toon je eigen berichten" link in het gebruikerspaneel te klikken, of via je eigen profiel. Om je eigen onderwerpen te zoeken, moet je de geavanceerde zoekfunctie gebruiken en de nodige opties invullen.',
	...
	'HELP_FAQ_USERSETTINGS_AVATAR_DISPLAY_ANSWER'	=> 'In je Gebruikerspaneel, onder “Profiel” kan je een avatar toevoegen door gebruik te maken van één van de volgende vier methodes: Gravatar, Galerij, Afstand of Upload. Het is aan de beheerders om avatars in te schakelen en om te kiezen op welke manier je een avatar kan gebruiken. Als je geen avatars kan gebruiken, neem dan contact op met een beheerder voor je vragen hierover.',
	...
	'HELP_FAQ_USERSETTINGS_CHANGE_SETTINGS_ANSWER'	=> 'Als je geregistreerd bent, worden al je gegevens opgeslagen in de database. Om ze te wijzigen moet je op de <em>gebruikerspaneel</em> link klikken (deze staat meestal bovenaan op de pagina, maar dit kan verschillen), daarna kan je je instellingen wijzigen.',
	...
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_ANSWER'	=> 'In het gebruikerspaneel onder "foruminstellingen", vind je de optie <em>Verberg mijn online status</em>. Als je deze optie activeert, dan zal je onzichtbaar zijn voor iedereen, behalve voor beheerders, moderators en jezelf.',
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_QUESTION'	=> 'Hoe kan ik onzichtbaar zijn in de online gebruikers lijst?',
	'HELP_FAQ_USERSETTINGS_LANGUAGE_ANSWER'	=> 'De meest voorkomende reden hiervoor is dat de beheerder je taal niet geïnstalleerd heeft, of dat nog niemand het forum in je taal vertaald heeft. Je kan altijd aan de beheerder vragen of hij het talenpakket, dat je nodig hebt, wilt installeren. Indien het nog niet bestaat, mag je gerust de vertaling maken. Meer informatie hieromtrent kan gevonden worden op de website van phpBB Limited (de link staat onderaan iedere pagina).',
	'HELP_FAQ_USERSETTINGS_LANGUAGE_QUESTION'	=> 'Mijn taal zit niet in de lijst!',
	'HELP_FAQ_USERSETTINGS_RANK_ANSWER'	=> 'Rangen, welke verschijnen onder je gebruikersnaam, geven een indicatie over het aantal berchten dat je hebt gemaakt of om bepaalde gebruikers te identificeren, bijv. moderators en beheerders. Over het algemeen kan je je rang niet wijzigen, aangezien ze ingesteld worden door een beheerder. Nu moet je natuurlijk het forum niet beginnen te spammen met onzinnig veel berichten, gewoon voor een hogere rang. Dit heeft zelfs mogelijk het tegenovergestelde effect, een beheerder of moderator kunnen je berichten aantal doen dalen.',
	'HELP_FAQ_USERSETTINGS_RANK_QUESTION'	=> 'Wat is mijn rang en hoe verander ik mijn rang?',
	'HELP_FAQ_USERSETTINGS_SERVERTIME_ANSWER'	=> 'Als je zeker bent dat je de correcte tijdzone en zomertijd goed hebt ingevuld en de tijd is nog steeds anders, is waarschijnlijk de tijd op de server verkeerd ingesteld en zullen de beheerders een correctie moeten maken.',
