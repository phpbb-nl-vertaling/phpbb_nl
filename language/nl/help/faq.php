...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_FORMATTING_ICONS_ANSWER'	=> 'Onderwerpiconen zijn kleine afbeeldingen die met berichten geassocieerd kunnen worden om zo hun inhoud kracht bij te zetten. Of je al dan niet gebruik kan maken van onderwerpiconen hangt af van de door de beheerder ingestelde rechten.',
	...
	'HELP_FAQ_GROUPS_ADMINISTRATORS_ANSWER'	=> 'Beheerders zijn gebruikers die alle rechten hebben over het gehele forum. Zij beheren alles in verband met het forum, zoals: rechten, het verbannen van gebruikers, gebruikersgroepen of moderators aanmaken, enz. Hun rechten zijn natuurlijk afhankelijk van welke de eigenaar aan hen heeft toegewezen. Ook afhankelijk van de beslissing van de eigenaar, hebben ze mogelijk alle moderator rechten in de forums.',
	...
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'	=> 'Als je lid bent van meerdere gebruikersgroepen, word je standaard gebruikersgroep gebruikt om je groepskleur en groepsrang te bepalen. De beheerder kan je de rechten geven om je standaard gebruikersgroep te wijzigen via het gebruikerspaneel.',
	...
	'HELP_FAQ_POSTING_FORUM_RESTRICTED_ANSWER'	=> 'Sommige forums zijn mogelijk alleen toegankelijk voor bepaalde gebruikers of gebruikersgroepen. Om berichten te zien, lezen, plaatsen, enz. heb je speciale rechten nodig. Deze rechten kun je alleen van moderators of beheerders krijgen, zij zijn dus ook degene met wie je hierover contact moet opnemen.',
	...
	'HELP_FAQ_POSTING_POLL_CREATE_ANSWER'	=> 'Een peiling aanmaken is heel gemakkelijk, als je een nieuw onderwerp aanmaakt (of het eerste bericht in een onderwerp bewerkt en als je daar rechten voor hebt) zou je een "voeg peiling toe" tabblad moeten zien onderaan het berichten-gedeelte (als je dit tabblad niet kan zien, heb je niet de juiste rechten om peilingen aan te maken). Je moet een titel voor de peiling invullen bij "peilingsvraag" en dan minstens 2 mogelijkheden invullen in het "peilingopties"-tekstgedeelte (limiet is ingesteld door de beheerder), met elke optie gescheiden door middel van een nieuwe regel. Je kunt ook instellen hoeveel opties een gebruiker mag kiezen onder "opties per gebruiker" en een tijdslimiet in dagen voor de peiling (0 is een peiling van oneindige duur).',
