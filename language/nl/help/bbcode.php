...
$lang = array_merge($lang, array(
	...
	'HELP_BBCODE_IMAGES_ATTACHMENT_ANSWER'	=> 'Bijlagen kunnen, indien de beheerder de bijlagenfunctie heeft aangezet en je de nodige rechten hebt om bijlagen toe te voegen, overal worden toegevoegd door middel van de <strong>[attachment=][/attachment]</strong> tag. In het berichtvenster is er een selectie lijst om bijlagen toe te voegen.',
	...
	'HELP_BBCODE_OTHERS_CUSTOM_ANSWER'	=> 'Als je beheerder van dit forum bent en over de nodige rechten beschikt kun je extra BBCodes toevoegen in het beheerderspaneel op de pagina van "BBCodes".',
