...
$lang = array_merge($lang, array(
	...
	'ATTACH_QUOTA_REACHED'		=> 'Sorry, het bijlagelimiet van het forum is bereikt.',
	...
	'DISALLOWED_CONTENT'		=> 'De upload is geweigerd omdat de geüploade bestand mogelijk gevaarlijk is.',
	'DISALLOWED_EXTENSION'		=> 'De extensie %s is niet toegestaan.',
	'DRAFT_LOADED'				=> 'Concept is in berichtengebied geladen, je kunt nu je bericht afmaken.<br />Je concept zal verwijderd worden na het versturen van dit bericht.',
	'DRAFT_LOADED_PM'			=> 'Concept is in berichtengebied geladen, je kunt nu je privébericht afmaken.<br />Je concept zal verwijderd worden na het versturen van dit privébericht.',
	...
	'LOAD_DRAFT_EXPLAIN'		=> 'Hier kun je het concept selecteren waarmee je verder wilt schrijven. Je bestaande bericht zal worden geannuleerd, alle bestaande berichten inhoud zal worden verwijderd. Bekijk, wijzig en verwijder concepten in het gebruikerspaneel.',
	...
	'POST_APPROVAL_NOTIFY'		=> 'Je zult op de hoogte steld worden wanneer je bericht goedgekeurd is.',
	'POST_CONFIRMATION'			=> 'Bevestiging van plaatsten',
	'POST_CONFIRM_EXPLAIN'		=> 'Om automatische berichten te voorkomen, vereist dit forum dat je een bevestigingscode invult. De code is weergegeven in de afbeelding die je hieronder kan zien. Als je visueel gehandicapt bent en de code niet kan lezen, neem dan contact op met de %beheerder%s.',
	...
	'TOO_MANY_URLS'				=> 'Je bericht bevat te veel URLs. Een maximum van %d URL\'s zijn toegestaan.',
	...
	'UNGLOBALISE_EXPLAIN'		=> 'Om dit onderwerp terug te schakelen van algemeen naar een normaal onderwerp, moet je het forum selecteren waarin dit onderwerp geplaatst zal worden.',
